...
ActiveRecord::Schema[7.1].define(version: 2024_06_14_132222) do
  ...
  create_table "sales", force: :cascade do |t|
    ...
    t.bigint "music_record_id", null: false
    t.float "price"
    t.date "sale_date"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["music_record_id"], name: "index_sales_on_music_record_id"
  ...
  add_foreign_key "sales", "music_records"
